...
def _generate_openai(prompt: str) -> tuple[str, str]:
    ...
    return response.choices[0].message.content.strip(), "openai/gpt-3.5-turbo"
...
def _generate_anthropic(prompt: str) -> tuple[str, str]:
    ...
    return response.content[0].text.strip(), "anthropic/claude-3-haiku"
...
def query(
    ...
    has_anthropic = anthropic_key and anthropic_key != "your_key_here"
